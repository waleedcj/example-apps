			...
			>
				...
				>
					<View style={styles.headerContainer}>
						<Text style={[styles.headerTitle, { color: colors.Neutral700 }]}>
							Create Your Profile
						</Text>
              ...
              />
						...
						{/* <RadialGradientBackground
							startColor={appColors.radialGradient.start}
							middleColor={appColors.radialGradient.middle}
							endColor={appColors.radialGradient.end}
						>
							<TouchableOpacity
						...
						<TouchableOpacity
							...
							activeOpacity={0.8}
						>
							<Link href={"/radialBackground"} style={styles.submitButtonText}>Create Profile</Link>
						</TouchableOpacity>
					</View>
				</ScrollView>
			</KeyboardAvoidingView>
